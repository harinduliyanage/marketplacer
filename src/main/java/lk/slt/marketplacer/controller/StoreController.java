...
public interface StoreController {
    ...
    public StoreDto createStore(@PathVariable("userId") String userId, @Valid @RequestBody CreateStoreDto createStoreDto);
    ...
    public StoreDto updateStore(@PathVariable("userId") String userId, @PathVariable("storeId") String storeId, @Valid @RequestBody UpdateStoreDto updateStoreDto);
